...
public class ProcCylinderBlend : MonoBehaviour
{
    ...
    private void BuildCylinder()
    {
        ...
        for (int i = 0; i <= m_HeightSegmentCount; i++)
        {
            ...
            BuildRing(m_RadialSegmentCount, centerPos, m_Radius, part, i > 0, rotation);

            if (i == 0)
            {
                BuildCap(m_RadialSegmentCount, centerPos, m_Radius, false, rotation);
            }
            else if (i == m_HeightSegmentCount)
            {
                BuildCap(m_RadialSegmentCount, centerPos, m_Radius, true, rotation);
            }
        }
